...
import kotlinx.android.synthetic.main.sv_activity_mock_attributes_bs.*
...
class ButtonSettingAttributesTests {
    ...
    @Before
    fun setup() {
        MockActivity.layout = R.layout.sv_activity_mock_attributes_bs
        restartActivity()
    }
    ...
    fun test_CheckmarkIcon_SetFromAttributes() {
        onView(withId(R.id.iv_checkmark)).check(matches(withDrawable(R.drawable.sv_test_ic_check_red)))
    }
